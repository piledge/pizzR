fPoll.dictionary <- data.frame(id=c(1, 2, 3, 4, 5, 6, 10, 11, 12, 13, 14, 15, 19, 20, 22, 23, 26, 28, 30),
                               species=c('picea, other coniferous wood', 'abies', 'larix', 'white pine', 'black pine',
